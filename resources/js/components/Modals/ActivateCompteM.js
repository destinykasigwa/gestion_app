        ...
        <div className="modal-dialog">
          <div className="modal-content">
            <div className="modal-header">
              <h4 style={{color:"#000"}} className="modal-title">Activation de compte</h4>
            ...
            <div className="modal-body">
             ...
             <div className="col-md-12">
                  ...
                  <div className="row">
                      <div className="col-md-12">
                        <h4 style={{color:"#000"}}> Etes vous sûr de pouvoir activé ce compte <strong>{this.props.refCompt}</strong> ?  </h4>
                      </div>                   
                  </div>
              </form>
            ...
            <button type="button" className="btn btn-success"  onClick={this.activationCompte}>Activer</button>
