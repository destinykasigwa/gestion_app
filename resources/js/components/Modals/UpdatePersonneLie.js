        ...
        handleChange(event){
          ...
          [event.target.name] : event.target.value
           ...
           static getDerivedStateFromProps(props,current_state){
             ...
             if(current_state.personneLieName && (current_state.personneLieName !== props.personneLieData.personneLieName)){
                return null;
            }
            if(current_state.lieuNaissLie && (current_state.lieuNaissLie !== props.personneLieData.lieuNaissLie)){
                return null;
            }
             if(current_state.dateNaissLie && (current_state.dateNaissLie !== props.personneLieData.dateNaissLie)){
                 return null;
             }
             if(current_state.degreParante && (current_state.degreParante !== props.personneLieData.degreParante)){
                return null;
            }
           
             //updating data from props below
             if(current_state.personneLieName !== props.personneLieData.personneLieName || 
                current_state.personneLieName === props.personneLieData.personneLieName){
                personneLieUpdate.personneLieName=props.personneLieData.personneLieName; 
             }
              
             if(current_state.lieuNaissLie !== props.personneLieData.lieuNaissLie || 
             ...
             if(current_state.dateNaissLie !== props.personneLieData.dateNaissLie || 
              ...
              if(current_state.degreParante !== props.personneLieData.degreParante || 
           ...
           UpdatePersonneLieData=(e)=>{
             ...
             axios.post('update/personnelie/data',{
