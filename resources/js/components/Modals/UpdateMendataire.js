        ...
        <div className="modal-dialog modal-lg">
          <div className="modal-content">
            <div className="modal-header">
              <h4 style={{color:"#000"}} className="modal-title">Modification du mendataire <strong> {this.props.mendatData.mendataireName}  </strong></h4>
