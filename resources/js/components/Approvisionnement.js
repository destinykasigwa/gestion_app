              ...
              //GET VALUES FROM INPUT
               ...
               saveOperation=async(e)=>{
                ...
                >
                <div className="col-md-3" style={{background:"#fff",padding:"10px"}}>
                <form>
                <table>
                <tr>
                <td>
                ...
                <div className="input-group input-group-sm ">
                    <select
                        ...
                        value={this.state.caissier}
                    >
                        <option value="">
                            Sélectionnez
                        </option>
                        {this.state.fetchCaissierInDb &&
                        this.state.fetchCaissierInDb.map((res,index)=>{  
                        return(
                        <option value={res.NumCompte}>
                        {res.NomCompte}
                        </option>
                        )                   
                         })
                ...
                <div className="col-md-4 appro-table-div"
                style={{
                    background: "#fff",
                    padding: "5px",
                }}
