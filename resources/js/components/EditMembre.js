...
handUpdate = async (event)=>{
    ...
    const res=await axios.post("/updatemembre/",data);
...
if(res.data.success==1){
    Swal.fire({
       title:"Success",
       text:res.data.msg+" Numero de compte :"+this.state.numCompte,
       icon:"success",
       button:"OK!"
   })
   this.setState({ disabled: !this.state.disabled });
...
handleGetRow= async(e)=>{
  e.preventDefault();
const getDataToUpDate=await axios.get("api/"+this.state.compteToSearch)
...
/>
<td><button  type="button" style={{borderRadius:"0px",width:"100%",height:"30px",fontSize:"12px"}} class="btn btn-primary" onClick={this.handleGetRow} > <i class="fas fa-search"></i></button></td>
</div>
<div className="input-group input-group-sm ">
<input
...
<input
    ...
    className={`form-control ${this.state.error_list.numCompte && "is-invalid"}`}
    name="numCompte"
...
<div className="col-md-2">
    <table style={{marginLeft:"5px",border:"3px solid #fff"}}>
        <tr>
            <td><button type="button" style={{borderRadius:"0px",width:"100%",height:"30px",fontSize:"12px"}} id="ajouterbtn" class="btn btn-primary" onClick={this.handleNew} >Ajouter <i class="fas fa-database"></i></button></td>
        </tr>
       
           {this.state.fetchData &&
        <tr>
            <td><a style={{borderRadius:"0px",width:"100%",height:"30px",fontSize:"12px"}} id="modifierbtn" class="btn btn-primary" href={`edit-membre/${this.state.compteToSearch}`} >Modifier <i class="fas fa-edit"></i></a></td>
        </tr>
        }
        <tr>
            <td><button type="button" style={{borderRadius:"0px",width:"100%",height:"30px",fontSize:"12px"}} id="validerbtn" class="btn btn-primary" onClick={this.handleSubmit}>Valider <i class="fas fa-check"></i></button></td>
        </tr>
        
        </table>
    </div>
    <div className="col-md-2">
                    <table style={{border:"3px solid #fff",padding:"5px"}}>
                      <tr>
                          <td></td>
                          <td>
                          <img src="dist/img/user2-160x160.jpg" alt="..." class="img-thumbnail"/>
                          </td>
                      </tr>
            ...
            <div className="col-md-12">
                <form method="POST">
                    ...
                    <td>
                        {" "}
                        <select
                           className={`form-control ${this.state.error_list.provinceActuelle && "is-invalid"}`}
                            id="province"
                            style={
                                inputColor
                            }
                ...
                <tr>
                    ...
                    <td>
                        {" "}
                        <select
                        className={`form-control ${this.state.error_list.villeActuelle && "is-invalid"}`}
                            id="terrouville"
                            style={
                                inputColor
                            }
                        ...
                        {this.state.provinceActuelle==="Bas-Uele"  &&
                        <React.Fragment>
                        <option value="Aketi">
                        Aketi
                       </option> 
                       ...
                       {this.state.provinceActuelle==="Equateur"  &&
                        <React.Fragment>
                        ...
                        <option value="Makanza">
                         ...
                         {this.state.provinceActuelle==="Haut-Katanga"  &&
                        <React.Fragment>
                        ...
                        <option value="Sakania">
                         ...
                         {this.state.provinceActuelle==="Haut-Lomami"  &&
                        <React.Fragment>
                        <option value="Bukama">
                        Bukama
                       </option> 
                      ...
                      {this.state.provinceActuelle==="Haut-Uele"  &&
                        <React.Fragment>
                      ...
                      {this.state.provinceActuelle==="Ituri"  &&
                        <React.Fragment>
                        ...
                        Mongwalu ville
                         ...
                         {this.state.provinceActuelle==="Nord-Kivu"  &&
                        <React.Fragment>
                        <option value="Beni">
                        Beni
                       </option> 
                        ...
                        Walikale
                          ...
                          {this.state.provinceActuelle==="Sud-Kivu"  &&
                        <React.Fragment>
                ...
                <tr>
                    <td>
                        ...
                        >
                            Secteur chefferie ou commune*
                        </label>{" "}
                    </td>
                    <td>
                        {" "}
                        <select
                        className={`form-control ${this.state.error_list.CommuneActuelle && "is-invalid"}`}
                            id="secteur"
                            style={
                                inputColor
                            }
                        ...
                        {this.state.villeActuelle==="Bukavu ville"  &&
                        <React.Fragment>
                        <option value="Bagira">
                        Bagira
                       </option> 
                        ...
                        {this.state.villeActuelle==="Goma ville"  &&
                        <React.Fragment>
                        <option value="Goma">
                        Goma
                       </option> 
                ...
                <tr>
                    ...
                    <td>
                        {" "}
                        <select
                        className={`form-control ${this.state.error_list.QuartierActuelle && "is-invalid"}`}
                            id="groupement"
                            style={
                                inputColor
                            }
                        ...
                        {this.state.CommuneActuelle==="Goma"  &&
                        <React.Fragment>
                        <option value="Himbi">
                        Himbi
                       </option> 
                        ...
                        {this.state.CommuneActuelle==="Karisimbi"  &&
                        <React.Fragment>
                        <option value="Bujovu">
                        Bujovu
                       </option> 
            ...
            <form method="POST">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input readOnly id="nomparain"  type="text" style={inputColor} name="parainName"    value={this.state.parainName ? this.state.parainName : this.state.fetchData && this.state.fetchData.parainName}
                            onChange={this.handleChange}  
                             />  
                    </td>
                </tr>
        ...
        >
            ...
            <form method="POST">
                 ...
                 <tr>
                     ...
                     <td>
                         <select
                            ...
                            <option value="Célibétaire">Célibétaire</option>
                            <option value="Veuf(ve)">Veuf(ve)</option>
                         </select>
                     </td>                  
                 </tr>
                 ...
                 <tr>
                    ...
                    <table style={{marginLeft:"5px",border:"3px solid #fff"}}>
                      <tr>
                          <td><button type="button" style={{borderRadius:"0px",width:"100%",height:"30px",fontSize:"12px"}} class="btn btn-primary">Ajouter <i class="fas fa-database"></i></button></td>
                      </tr>
                      <tr>
                          <td><button type="button" style={{borderRadius:"0px",width:"100%",height:"30px",fontSize:"12px"}} class="btn btn-primary">Modifier <i class="fas fa-edit"></i></button></td>
                      </tr>
                      <tr>
                          <td><button type="button" style={{borderRadius:"0px",width:"100%",height:"30px",fontSize:"12px"}} class="btn btn-primary">Valider <i class="fas fa-check"></i></button></td>
                      </tr>
                      <tr>
                          <td><button type="button" style={{borderRadius:"0px",width:"100%",height:"30px",fontSize:"12px"}} class="btn btn-danger">Supprimer <i class="fas fa-trash"></i></button></td>
                      </tr>
                      </table>
                    </div>
                   </div>
                 ...
                 <tr>
                     ...
                     <td>
                         <input
                             ...
                             onChange={this.handleChange} disabled={this.state.disabled ? "disabled" : ""}  />
                     </td>
        ...
        <form method="POST">
            ...
            <tr>
                     <td>
                         ...
                         >
                             Compte d'Epargne non encore crée
                         </label>
                     </td>
                     <td>
                         <select
                     ...
                     <td><button type="button" style={{borderRadius:"0px",width:"100%",height:"30px",fontSize:"12px"}} class="btn btn-primary">Créer <i class="fas fa-check"></i></button></td>
