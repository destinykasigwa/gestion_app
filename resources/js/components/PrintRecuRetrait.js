...
export default class PrintRecuRetrait extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            isloading: true,
        ...
        this.dispalyRecuRetrait = this.dispalyRecuRetrait.bind(this);
    }
    ...
    componentDidMount() {
        ...
        this.dispalyRecuRetrait();
    }
    dispalyRecuRetrait = async () => {
        const res = await axios.get("rapport/recu/retrait");
        if (res.data.devise == 1) {
            this.setState({
                getDataUSD: res.data.dataRetraitUSD,
            });
        } else if (res.data.devise == 2) {
            this.setState({
                getDataCDF: res.data.dataRetraitCDF,
            });
        }
    };
