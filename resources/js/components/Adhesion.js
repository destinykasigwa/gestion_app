...
/>
<td><button  type="button" style={{borderRadius:"0px",width:"100%",height:"30px",fontSize:"12px"}} className="btn btn-primary" onClick={this.handleGetRow} > <i className="fas fa-search"></i></button></td>
</div>
<div className="input-group input-group-sm ">
<input
...
<div className="col-md-2">
    <table style={{marginLeft:"5px",border:"3px solid #fff"}}>
        <tr>
            <td><button type="button" style={{borderRadius:"0px",width:"100%",height:"30px",fontSize:"12px"}} id="ajouterbtn" className="btn btn-primary" onClick={this.handleNew} >Ajouter <i className="fas fa-database"></i></button></td>
        </tr>
        ...
        <tr>
            <td><button type="button" style={{borderRadius:"0px",width:"100%",height:"30px",fontSize:"12px"}} id="validerbtn" className="btn btn-primary" onClick={this.handleSubmit}>Valider <i className="fas fa-check"></i></button></td>
        </tr>
    ...
    <div className="col-md-2">
                    <table style={{border:"3px solid #fff",padding:"5px"}}>
                      <tr>
                          <td></td>
                          <td>
                          <img src="dist/img/user2-160x160.jpg" alt="..." className="img-thumbnail"/>
                          </td>
                      </tr>
...
<Mendataire num={this.state.compteToSearch && this.state.compteToSearch} refCompt={this.state.fetchData && this.state.fetchData.refCompte}/>
    ...
    <div className="card card-default">
        ...
        >
            <div className="col-md-12">
              ...
              <PersonneLie num={this.state.compteToSearch && this.state.compteToSearch} refCompt={this.state.fetchData && this.state.fetchData.refCompte}/>
    ...
    >
        <form method="POST">
            ...
            <tr>
                     ...
                     <td><button type="button" style={{borderRadius:"0px",width:"100%",height:"30px",fontSize:"12px"}} className="btn btn-primary">Créer <i className="fas fa-check"></i></button></td>
