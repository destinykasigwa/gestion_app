...
public function getPersonneLieDetails(Request $request) {
 ...
 public function getAllpersonneLie($id){
    try {
      ...
      ->paginate(30, array('personne_lies.personneLieName as nameP', 
      'personne_lies.lieuNaissLie as lieuP','personne_lies.dateNaissLie as dateP',
      'personne_lies.degreParante as degreP',
      'personne_lies.id as idPersonneLie'));
